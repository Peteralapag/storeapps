...
<table style="width: 100%" class="tables" cellpadding="4" cellspacing="5">
	...
	<tr>
		...
		<td style="width: 10px">&nbsp;</td>
		<td style="width: 24%"><input id="category" type="text" class="form-control" value="RAWMATS" disabled></td>
		<td style="width: 10px">&nbsp;</td>
		<td style="width: 24%">
