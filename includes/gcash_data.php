...
<?php } 
	...
	$breads = $functions->getGcashBreakdown('BREADS',$store_branch,$trans_date,$branch_shift,$db);
	$cakes = $functions->getGcashBreakdown('CAKES',$store_branch,$trans_date,$branch_shift,$db);
	$specials = $functions->getGcashBreakdown('SPECIALS',$store_branch,$trans_date,$branch_shift,$db);
	$beverages = $functions->getGcashBreakdown('BEVERAGES',$store_branch,$trans_date,$branch_shift,$db);	
	$bottledwater = $functions->getGcashBreakdown('BOTTLED WATER',$store_branch,$trans_date,$branch_shift,$db);
	$icecream = $functions->getGcashBreakdown('ICE CREAM',$store_branch,$trans_date,$branch_shift,$db);
	$merchandiseothers = $functions->getGcashBreakdown('MERCHANDISE OTHERS',$store_branch,$trans_date,$branch_shift,$db);
	$coffee = $functions->getGcashBreakdown('COFFEE',$store_branch,$trans_date,$branch_shift,$db);
	$milktea = $functions->getGcashBreakdown('MILK TEA',$store_branch,$trans_date,$branch_shift,$db);
