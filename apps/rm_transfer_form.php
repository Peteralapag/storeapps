...
<table style="width: 100%" class="tables" cellpadding="4" cellspacing="5">
	...
	<tr>
		...
		<td style="width: 10px">&nbsp;</td>
		<td style="width: 24%">
		&nbsp;<?php if($transmode == 'edit') { ?><!--button id="ttb" class="btn btn-success" style="width: auto" onclick="transferToBranch('<?php echo $rowid; ?>')">Send to <?php echo $transfer_to; ?></button--><?php }?></td>
		<td style="width: 10px">&nbsp;</td>
...
function commitAction(transmode)
{
	...
	else if(item_id === '') { app_alert("Item Name Error","No ITEM ID.","warning","Ok","itemname","focus"); return false; }
