...
?>
<style>
.table-ba th, .table-ba td {padding: 5px 5px 5px 5px;border:1px solid #cecece}
.table-ba th {background: dodgerblue;color: #fff;}
...
<!-- ############################################################################################## -->                                      	
                   	<?php echo $classba->GetBakersGuideData($item_code,$db)?>
<!-- ############################################################################################## -->                                      							
                    </td>
                </tr>
<?php } } else { ?>
