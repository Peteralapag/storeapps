...
<?php
$query ="SELECT * FROM store_grab_data $q ORDER BY status,id DESC";  
...
<?php } 
	...
	$breads = $functions->getGrabBreakdown('BREADS',$store_branch,$trans_date,$branch_shift,$db);
	$cakes = $functions->getGrabBreakdown('CAKES',$store_branch,$trans_date,$branch_shift,$db);
	$specials = $functions->getGrabBreakdown('SPECIALS',$store_branch,$trans_date,$branch_shift,$db);
	$beverages = $functions->getGrabBreakdown('BEVERAGES',$store_branch,$trans_date,$branch_shift,$db);	
	$bottledwater = $functions->getGrabBreakdown('BOTTLED WATER',$store_branch,$trans_date,$branch_shift,$db);
	$icecream = $functions->getGrabBreakdown('ICE CREAM',$store_branch,$trans_date,$branch_shift,$db);
	$merchandiseothers = $functions->getGrabBreakdown('MERCHANDISE OTHERS',$store_branch,$trans_date,$branch_shift,$db);
	$coffee = $functions->getGrabBreakdown('COFFEE',$store_branch,$trans_date,$branch_shift,$db);
	$milktea = $functions->getGrabBreakdown('MILK TEA',$store_branch,$trans_date,$branch_shift,$db);
